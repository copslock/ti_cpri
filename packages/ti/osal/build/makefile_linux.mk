...
#*******************************************************************************
#* FILE NAME: ./build/makefile_linux.mk
#*
...
ARMV7OBJDIR ?= ./obj
ARMV7OBJDIR := $(ARMV7OBJDIR)/linux/lib
ARMV7OBJDIR_SO := $(ARMV7OBJDIR)/linux/lib_so
DEBUG_FLAG  ?= -O2
...
INTERNALDEFS = -D__ARMv7 -D_LITTLE_ENDIAN=1 -D_VIRTUAL_ADDR_SUPPORT -DMAKEFILE_BUILD $(LDFLAGS) -D__LINUX_USER_SPACE
...
$(ARMV7LIBDIR)/libosal.a: $(COMMONSRCCOBJS) $(ARMV7LIBDIR)/.created
	@echo archiving $? into $@ ...
	@$(AR) -r $@ $?

libosal.so: $(COMMONSRCCOBJS_SO)
