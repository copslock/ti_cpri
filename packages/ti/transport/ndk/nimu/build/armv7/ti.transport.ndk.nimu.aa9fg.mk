...
#*******************************************************************************
#* FILE NAME: ./build/armv7/ti.transport.ndk.nimu.aa9fg.mk
#*
...
$(COMMONSRCCOBJS):.\build\armv7\ti.transport.ndk.nimu.aa9fg.mk
.\build\armv7\ti.transport.ndk.nimu.aa9fg.mk:
...
$(LIBDIR)/armv7/ti.transport.ndk.nimu.aa9fg : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
