...
#*******************************************************************************
#* FILE NAME: ./build/c66/ti.transport.ndk.nimu.ae66e.mk
#*
...
OBJEXT = oe66e
AOBJEXT = se66e
CFLAGS_INTERNAL = -mo -o3 -q -k -eo.o -DBIGENDIAN -DMEM_BARRIER_DISABLE -me -mv6600 --abi=eabi
...
$(COMMONSRCCOBJS):.\build\c66\ti.transport.ndk.nimu.ae66e.mk
.\build\c66\ti.transport.ndk.nimu.ae66e.mk:
...
$(LIBDIR)/c66/ti.transport.ndk.nimu.ae66e : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
