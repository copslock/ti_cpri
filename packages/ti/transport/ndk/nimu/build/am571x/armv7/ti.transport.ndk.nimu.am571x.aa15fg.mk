...
#*******************************************************************************
#* FILE NAME: ./build/am571x/armv7/ti.transport.ndk.nimu.am571x.aa15fg.mk
#*
...
OBJDIR =  $(LIBDIR)/am571x/armv7/obj/soc
...
COMMONSRCC= \
    ...
    soc/am571x/NIMU_soc.c

# FLAGS for the COMMONSRC Files
COMMONSRCCFLAGS =   -DSOC_AM571x  -I./src -I. 
...
$(COMMONSRCCOBJS):.\build\am571x\armv7\ti.transport.ndk.nimu.am571x.aa15fg.mk
.\build\am571x\armv7\ti.transport.ndk.nimu.am571x.aa15fg.mk:
...
$(LIBDIR)/am571x/armv7/ti.transport.ndk.nimu.am571x.aa15fg : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am571x/armv7 ]; then $(MKDIR) $(LIBDIR)/am571x/armv7 ; fi;
