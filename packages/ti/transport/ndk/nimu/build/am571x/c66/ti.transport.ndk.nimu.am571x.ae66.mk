...
#*******************************************************************************
#* FILE NAME: ./build/am571x/c66/ti.transport.ndk.nimu.am571x.ae66.mk
#*
...
OBJDIR =  $(LIBDIR)/am571x/c66/obj/soc
...
$(COMMONSRCCOBJS):.\build\am571x\c66\ti.transport.ndk.nimu.am571x.ae66.mk
.\build\am571x\c66\ti.transport.ndk.nimu.am571x.ae66.mk:
...
$(LIBDIR)/am571x/c66/ti.transport.ndk.nimu.am571x.ae66 : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am571x/c66 ]; then $(MKDIR) $(LIBDIR)/am571x/c66 ; fi;
