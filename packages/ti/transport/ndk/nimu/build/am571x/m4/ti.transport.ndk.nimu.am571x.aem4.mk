...
#*******************************************************************************
#* FILE NAME: ./build/am571x/m4/ti.transport.ndk.nimu.am571x.aem4.mk
#*
...
OBJDIR =  $(LIBDIR)/am571x/m4/obj/soc
...
$(COMMONSRCCOBJS):.\build\am571x\m4\ti.transport.ndk.nimu.am571x.aem4.mk
.\build\am571x\m4\ti.transport.ndk.nimu.am571x.aem4.mk:
...
$(LIBDIR)/am571x/m4/ti.transport.ndk.nimu.am571x.aem4 : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am571x/m4 ]; then $(MKDIR) $(LIBDIR)/am571x/m4 ; fi;
