...
#*******************************************************************************
#* FILE NAME: ./build/am572x/m4/ti.transport.ndk.nimu.am572x.aem4.mk
#*
...
OBJDIR =  $(LIBDIR)/am572x/m4/obj/soc
...
$(COMMONSRCCOBJS):.\build\am572x\m4\ti.transport.ndk.nimu.am572x.aem4.mk
.\build\am572x\m4\ti.transport.ndk.nimu.am572x.aem4.mk:
...
$(LIBDIR)/am572x/m4/ti.transport.ndk.nimu.am572x.aem4 : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am572x/m4 ]; then $(MKDIR) $(LIBDIR)/am572x/m4 ; fi;
