...
#*******************************************************************************
#* FILE NAME: ./build/am572x/c66/ti.transport.ndk.nimu.am572x.ae66.mk
#*
...
OBJDIR =  $(LIBDIR)/am572x/c66/obj/soc
...
$(COMMONSRCCOBJS):.\build\am572x\c66\ti.transport.ndk.nimu.am572x.ae66.mk
.\build\am572x\c66\ti.transport.ndk.nimu.am572x.ae66.mk:
...
$(LIBDIR)/am572x/c66/ti.transport.ndk.nimu.am572x.ae66 : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am572x/c66 ]; then $(MKDIR) $(LIBDIR)/am572x/c66 ; fi;
