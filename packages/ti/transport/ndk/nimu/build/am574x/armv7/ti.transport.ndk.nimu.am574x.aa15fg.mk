...
#*******************************************************************************
#* FILE NAME: ./build/am574x/armv7/ti.transport.ndk.nimu.am574x.aa15fg.mk
#*
...
OBJDIR =  $(LIBDIR)/am574x/armv7/obj/soc
...
$(COMMONSRCCOBJS):.\build\am574x\armv7\ti.transport.ndk.nimu.am574x.aa15fg.mk
.\build\am574x\armv7\ti.transport.ndk.nimu.am574x.aa15fg.mk:
...
$(LIBDIR)/am574x/armv7/ti.transport.ndk.nimu.am574x.aa15fg : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am574x/armv7 ]; then $(MKDIR) $(LIBDIR)/am574x/armv7 ; fi;
