...
#*******************************************************************************
#* FILE NAME: ./build/am335x/armv7/ti.transport.ndk.nimu.am335x.aa8fg.mk
#*
...
OBJDIR =  $(LIBDIR)/am335x/armv7/obj/soc
...
COMMONSRCC= \
    ...
    soc/am335x/NIMU_soc.c

# FLAGS for the COMMONSRC Files
COMMONSRCCFLAGS =   -DSOC_AM335x  -I./src -I. 
...
$(COMMONSRCCOBJS):.\build\am335x\armv7\ti.transport.ndk.nimu.am335x.aa8fg.mk
.\build\am335x\armv7\ti.transport.ndk.nimu.am335x.aa8fg.mk:
...
$(LIBDIR)/am335x/armv7/ti.transport.ndk.nimu.am335x.aa8fg : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
	if [ ! -d $(LIBDIR)/am335x/armv7 ]; then $(MKDIR) $(LIBDIR)/am335x/armv7 ; fi;
