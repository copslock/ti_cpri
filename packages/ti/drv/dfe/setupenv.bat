@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building DFE
@REM ******************************************************************************
@REM * FILE NAME: pdksetupenv.bat
@REM *
@REM * DESCRIPTION: 
@REM *  Configures and sets up the Build Environment for DFE. 
...
@REM DEFINE ENVIRONMENT PARAMETERS
set C6X_GEN_INSTALL_PATH=C:\ti\ccsv5\tools\compiler\c6000_7.3.4
set XDC_INSTALL_PATH=C:/ti/xdctools_3_23_03_53
set CG_XML_BIN_INSTALL_PATH=C:/ti/cg_xml/bin
set EDMA3_LLD_INSTALL_PATH=C:/ti/edma3_lld_02_11_09_08
set DOXYGEN_INSTALL_PATH=C:\Program Files\doxygen\bin
set HTML_HELP_WORKSHOP_INSTALL_PATH=C:\Program Files\HTML Help Workshop
REM set HTML_HELP_WORKSHOP_INSTALL_PATH 
@REM *******************************************************************************
...
@REM Windows Path
set PATH=C:\Windows\System32;C:\ti\ccsv5\ccs_base\scripting\bin
...
Title DFE LLD Build Environment
