void serdes_setup_6p144(UINT serdes_inst)
{
   UINT base;
  if(serdes_inst==0)
...
serdes_write_byte(base + 0x00000014, 0x5e);
serdes_write_byte(base + 0x00000015, 0x5e);
serdes_write_byte(base + 0x00000060, 0x5c);
...
serdes_write_byte(base + 0x00000480, 0x54);
serdes_write_byte(base + 0x00000482, 0x54);
...
serdes_write_byte(base + 0x00000680, 0x54);
serdes_write_byte(base + 0x00000682, 0x54);
...
serdes_write_byte(base + 0x00000a0b, 0x35);
serdes_write_byte(base + 0x00000a31, 0x5b);
serdes_write_byte(base + 0x00000a32, 0x5b);
