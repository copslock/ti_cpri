void serdes_setup_iqn_6p144(UINT serdes_inst)
{
   UINT base;
  if(serdes_inst==0)
...
serdes_write_byte(base + 0x00000214, 0x1c);
serdes_write_byte(base + 0x00000215, 0x6a);
...
serdes_write_byte(base + 0x00000414, 0x1c);
serdes_write_byte(base + 0x00000415, 0x6a);
...
serdes_write_byte(base + 0x00000614, 0x1c);
serdes_write_byte(base + 0x00000615, 0x6a);
...
serdes_write_byte(base + 0x00000814, 0x1c);
serdes_write_byte(base + 0x00000815, 0x6a);
serdes_write_byte(base + 0x00000818, 0x84);
...
serdes_write_byte(base + 0x0000088d, 0x3b);
