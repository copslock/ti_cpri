...
const unsigned int pcie0_pdctl           = PSC_PDCTL_BASE + ( 3 * 4);
const unsigned int pcie0_mdctl           = PSC_MDCTL_BASE + ( 10 * 4);
...
*/
const unsigned int pcie1_pdctl           = PSC_PDCTL_BASE + ( 4 * 4);
const unsigned int pcie1_mdctl           = PSC_MDCTL_BASE + ( 11 * 4);
...
const unsigned int osr_pdctl            = PSC_PDCTL_BASE + ( 21 * 4);
const unsigned int osr_mdctl            = PSC_MDCTL_BASE + ( 34 * 4);
