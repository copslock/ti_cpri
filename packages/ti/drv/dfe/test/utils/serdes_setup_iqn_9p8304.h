void serdes_setup_iqn_9p8304(UINT serdes_inst)
{
   UINT base;
  if(serdes_inst==0)
...
serdes_write_byte(base + 0x00000401, 0x80);
...
serdes_write_byte(base + 0x00000601, 0x80);
...
serdes_write_byte(base + 0x00000614, 0x8c);
serdes_write_byte(base + 0x00000615, 0x6d);
...
serdes_write_byte(base + 0x00000680, 0x3b);
serdes_write_byte(base + 0x00000682, 0x3b);
