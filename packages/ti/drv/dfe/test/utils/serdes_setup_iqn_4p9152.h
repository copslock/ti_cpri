void serdes_setup_iqn_4p9152(UINT serdes_inst)
{
   UINT base;
  if(serdes_inst==0)
...
serdes_write_byte(base + 0x00000014, 0x82);
serdes_write_byte(base + 0x00000015, 0x82);
serdes_write_byte(base + 0x00000060, 0x48);
serdes_write_byte(base + 0x00000061, 0x2c);
...
serdes_write_byte(base + 0x00000214, 0x78);
serdes_write_byte(base + 0x00000215, 0x6e);
serdes_write_byte(base + 0x00000218, 0xe4);
serdes_write_byte(base + 0x0000021a, 0x80);
serdes_write_byte(base + 0x0000021b, 0x75);
serdes_write_byte(base + 0x0000022c, 0x02);
serdes_write_byte(base + 0x0000022e, 0x10);
serdes_write_byte(base + 0x00000280, 0x70);
serdes_write_byte(base + 0x00000282, 0x70);
serdes_write_byte(base + 0x00000284, 0x95);
serdes_write_byte(base + 0x00000286, 0x0f);
serdes_write_byte(base + 0x00000287, 0x1d);
serdes_write_byte(base + 0x0000028d, 0x2c);
...
serdes_write_byte(base + 0x00000414, 0x78);
serdes_write_byte(base + 0x00000415, 0x6e);
serdes_write_byte(base + 0x00000418, 0xe4);
serdes_write_byte(base + 0x0000041a, 0x80);
serdes_write_byte(base + 0x0000041b, 0x75);
serdes_write_byte(base + 0x0000042c, 0x02);
serdes_write_byte(base + 0x0000042e, 0x10);
serdes_write_byte(base + 0x00000480, 0x70);
serdes_write_byte(base + 0x00000482, 0x70);
serdes_write_byte(base + 0x00000484, 0x95);
serdes_write_byte(base + 0x00000486, 0x0f);
serdes_write_byte(base + 0x00000487, 0x1d);
serdes_write_byte(base + 0x0000048d, 0x2c);
...
serdes_write_byte(base + 0x00000614, 0x78);
serdes_write_byte(base + 0x00000615, 0x6e);
serdes_write_byte(base + 0x00000618, 0xe4);
serdes_write_byte(base + 0x0000061a, 0x80);
serdes_write_byte(base + 0x0000061b, 0x75);
serdes_write_byte(base + 0x0000062c, 0x02);
serdes_write_byte(base + 0x0000062e, 0x10);
serdes_write_byte(base + 0x00000680, 0x70);
serdes_write_byte(base + 0x00000682, 0x70);
serdes_write_byte(base + 0x00000684, 0x95);
serdes_write_byte(base + 0x00000686, 0x0f);
serdes_write_byte(base + 0x00000687, 0x1d);
serdes_write_byte(base + 0x0000068d, 0x2c);
serdes_write_byte(base + 0x00000804, 0x80);
serdes_write_byte(base + 0x00000807, 0x7e);
serdes_write_byte(base + 0x00000808, 0x24);
serdes_write_byte(base + 0x0000080f, 0x02);
serdes_write_byte(base + 0x00000813, 0x1b);
serdes_write_byte(base + 0x00000814, 0x78);
serdes_write_byte(base + 0x00000815, 0x6e);
serdes_write_byte(base + 0x00000818, 0xe4);
serdes_write_byte(base + 0x0000081a, 0x80);
serdes_write_byte(base + 0x0000081b, 0x75);
serdes_write_byte(base + 0x0000082c, 0x02);
serdes_write_byte(base + 0x0000082e, 0x10);
serdes_write_byte(base + 0x00000880, 0x70);
serdes_write_byte(base + 0x00000882, 0x70);
serdes_write_byte(base + 0x00000884, 0x95);
serdes_write_byte(base + 0x00000886, 0x0f);
serdes_write_byte(base + 0x00000887, 0x1d);
serdes_write_byte(base + 0x0000088d, 0x2c);
serdes_write_byte(base + 0x00000a01, 0x08);
serdes_write_byte(base + 0x00000a0a, 0x72);
serdes_write_byte(base + 0x00000a0b, 0x37);
serdes_write_byte(base + 0x00000a31, 0x77);
serdes_write_byte(base + 0x00000a32, 0x77);
serdes_write_byte(base + 0x00000a85, 0x00);
