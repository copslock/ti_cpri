...
# VLAB Test to load A72_1_0, C66x_0, C66x_1, C7x, and all R5F cores (usage of BTCM) for IPC echo comm. testing
# 
...
binary_directory = "../../../../binary/ipc_echo_testb/bin/j721e_sim"
...
#
mcu1_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu1_0_debug.xer5f")
mcu2_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu1_1_debug.xer5f")
mcu3_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu2_0_debug.xer5f")
mcu4_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu2_1_debug.xer5f")
mcu5_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu3_0_debug.xer5f")
mcu6_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mcu3_1_debug.xer5f")
c66x0_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_c66xdsp_1_debug.xe66")
c66x1_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_c66xdsp_2_debug.xe66")
c7x_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_c7x_debug.xe71")
a72_bin_elf = os.path.join(binary_directory, "ipc_echo_testb_mpu1_0_debug.xa72fg")
...
#
# Load binary images (only do this here after RESET is released)
#
print("\n\nLoading R5 images...\n\n")
