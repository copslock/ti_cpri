@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building TSIP LLD
@REM ******************************************************************************
...
@echo ---------------------------------------
@echo Configuring TSIP LLD Build Environment
@echo off
...
set PDK_INSTALL_PATH=C:\test_pdk\pdk_keystone2_3_01_00_00\packages
:pdk_defined
...
Title TSIP LLD Build Environment

@echo TSIP LLD Build Environment Configured 
@echo ---------------------------------------
