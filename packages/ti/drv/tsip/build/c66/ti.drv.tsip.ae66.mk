...
#*******************************************************************************
#* FILE NAME: ./build/c66/ti.drv.tsip.ae66.mk
#*
...
empty =
space =$(empty) $(empty)
CC = $(C6X_GEN_INSTALL_PATH)/bin/cl6x -c -mo -o3 -q -k -eo.o -mv6600 --abi=eabi
...
$(COMMONSRCCOBJS):./build/c66/ti.drv.tsip.ae66.mk
./build/c66/ti.drv.tsip.ae66.mk:
...
$(LIBDIR)/c66/ti.drv.tsip.ae66 : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
