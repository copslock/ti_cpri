...
#*******************************************************************************
#* FILE NAME: ./lib/libsrio_aearmv7.mk
#*
...
ARMV7LIBDIR ?= ./lib
ARMV7OBJDIR ?= ./obj
ARMV7OBJDIR := $(ARMV7OBJDIR)/srio/lib
ARMV7OBJDIR_SO := $(ARMV7OBJDIR)/srio/lib_so
ARMV7BINDIR ?= ./bin
DEBUG_FLAG  ?= -O2
...
INTERNALDEFS = -D__ARMv7 -D_LITTLE_ENDIAN=1 -D_VIRTUAL_ADDR_SUPPORT -DMAKEFILE_BUILD -D__LINUX_USER_SPACE $(LDFLAGS)
...
$(ARMV7LIBDIR)/libsrio.a: $(COMMONSRCCOBJS) $(ARMV7LIBDIR)/.created
	@echo archiving $? into $@ ...
	@$(AR) -r $@ $(patsubst %.created,,$?)

libsrio.so: $(COMMONSRCCOBJS_SO)
