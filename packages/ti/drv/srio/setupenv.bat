@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building SRIO LLD
@REM ******************************************************************************
...
@REM *
@REM * Copyright (C) 2011-2012, Texas Instruments, Inc.
@REM *****************************************************************************

@echo ---------------------------------------
@echo Configuring SRIO LLD Build Environment
@echo off
...
@REM set PDK_INSTALL_PATH=C:\ti\pdk_keystone2_1_00_00_03\packages
set PDK_INSTALL_PATH=C:\ti\mcsdk_bios_3_00_00_05\pdk_keystone2_1_00_00_05\packages
:pdk_defined
...
REM *******************************************************************************
REM SRIO LLD depends upon the following packages:-
REM     - CSL Package for the CSL SRIO Functional Layer
REM     - CPPI LLD
REM     - QMSS LLD
...
Title SRIO LLD Build Environment

@echo SRIO LLD Build Environment Configured 
@echo -----------------------------------------------
