/******************************************************************************
 * FILE PURPOSE: MCBSP LLD DOCS Module specification file.
 ******************************************************************************
 * FILE NAME: Module.xs
 *
 * DESCRIPTION: 
 *  This file contains the module specification for the MCBSP LLD Documentation.
 *
...
function modBuild() 
{
    ...
    Pkg.makePrologue += "release: mcbsp_lld_document_generation\n";
    ...
    Pkg.otherFiles[Pkg.otherFiles.length++] = "docs/MCBSP_LLD_SDS.pdf";
    Pkg.otherFiles[Pkg.otherFiles.length++] = "docs/MCBSP_LLD_SoftwareManifest.pdf";
    Pkg.otherFiles[Pkg.otherFiles.length++] = "docs/ReleaseNotes_MCBSP_LLD.pdf";
