@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building PCIE LLD
@REM ******************************************************************************
...
@REM *
@REM * Copyright (C) 2012-2014, Texas Instruments, Inc.
@REM *****************************************************************************

@echo ---------------------------------------
@echo Configuring PCIE LLD Build Environment
@echo off
...
set PDK_INSTALL_PATH=C:\ti\pdk_keystone2_1_00_00_03\packages
:pdk_defined
...
Title PCIE LLD Build Environment

@echo PCIE LLD Build Environment Configured 
@echo ---------------------------------------
