@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building QMSS LLD
@REM ******************************************************************************
...
@echo ---------------------------------------
@echo Configuring QMSS LLD Build Environment
@echo off
...
REM *******************************************************************************
REM QMSS LLD depends upon the following packages:-
...
Title QMSS LLD Build Environment

@echo QMSS LLD Build Environment Configured 
@echo ---------------------------------------
