@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building PA LLD
@REM ******************************************************************************
...
@echo ---------------------------------------
@echo Configuring PA LLD Build Environment
@echo off
...
Title PA LLD Build Environment

@echo PA LLD Build Environment Configured 
@echo ---------------------------------------
