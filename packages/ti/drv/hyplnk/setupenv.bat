@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building hyplnk LLD
@REM ******************************************************************************
...
@echo ---------------------------------------
@echo Configuring hyplnk LLD Build Environment
@echo off
...
Title hyplnk LLD Build Environment

@echo hyplnk LLD Build Environment Configured 
@echo ---------------------------------------
