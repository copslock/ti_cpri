...
char *dump_Aif2Fl_AtEventIndex (Aif2Fl_AtEventIndex value) {
  ...
  case AIF2FL_EVENT_11:
    return "AIF2FL_EVENT_11";
  case AIF2FL_EVENT_12:
    return "AIF2FL_EVENT_12";
  case AIF2FL_EVENT_13:
    return "AIF2FL_EVENT_13";
  case AIF2FL_EVENT_14:
    return "AIF2FL_EVENT_14";
  case AIF2FL_EVENT_15:
    return "AIF2FL_EVENT_15";
  case AIF2FL_EVENT_16:
    return "AIF2FL_EVENT_16";
  case AIF2FL_EVENT_17:
    return "AIF2FL_EVENT_17";
  case AIF2FL_EVENT_18:
    return "AIF2FL_EVENT_18";
  case AIF2FL_EVENT_19:
    return "AIF2FL_EVENT_19";
  case AIF2FL_EVENT_2:
    return "AIF2FL_EVENT_2";
  case AIF2FL_EVENT_20:
    return "AIF2FL_EVENT_20";
  case AIF2FL_EVENT_21:
    return "AIF2FL_EVENT_21";
  case AIF2FL_EVENT_22:
    return "AIF2FL_EVENT_22";
  case AIF2FL_EVENT_23:
    return "AIF2FL_EVENT_23";
  case AIF2FL_EVENT_3:
...
char *dump_Aif2Fl_SdClockSelect (Aif2Fl_SdClockSelect value) {
  ...
  case AIF2FL_SD_BYTECLOCK_FROM_B8_B4:
    return "AIF2FL_SD_BYTECLOCK_FROM_B8_B4";
  case AIF2FL_SD_BYTECLOCK_FROM_B8_B4_DEFAULT:
    return "AIF2FL_SD_BYTECLOCK_FROM_B8_B4_DEFAULT";
  default:
    return "Illegal Enumeration Value";
  }
}
...
void dump_Aif2Fl_AdDioEngine (FILE *output, Aif2Fl_AdDioEngine *value) {
  ...
  fprintf(output, "  bEnIngressRsaFormat = %d\n", value->bEnIngressRsaFormat);
  fprintf(output, "}\n");
}
...
void dump_Aif2Fl_AtEventSetup (FILE *output, Aif2Fl_AtEventSetup *value) {
  ...
  fprintf(output, "  ]\n");
  fprintf(output, "  bEnableRadEvent[24] = [\n");
  for(i=0; i<24; i++) {
...
void dump_Aif2Fl_PdLinkSetup (FILE *output, Aif2Fl_PdLinkSetup *value) {
  ...
  fprintf(output, "  ]\n");
  fprintf(output, "  PostEncBitmap = %d\n", value->PostEncBitmap);
  fprintf(output, "  PreEncBitmap = %d\n", value->PreEncBitmap);
  ...
  fprintf(output, "  bHyperFrameEop[256] = [\n");
  for(i=0; i<256; i++) {
    fprintf(output, "    bHyperFrameEop[%d] = %d\n", i, value->bHyperFrameEop[i]);
  }
  fprintf(output, "  ]\n");
  fprintf(output, "}\n");
}
...
void dump_Aif2Fl_SdLinkSetup (FILE *output, Aif2Fl_SdLinkSetup *value) {
  ...
  fprintf(output, "  rxPolarity = %s\n", dump_Aif2Fl_SdRxInvertPolarity(value->rxPolarity));
  fprintf(output, "}\n");
}
...
void dump_Aif2Fl_SdRxStatus (FILE *output, Aif2Fl_SdRxStatus *value) {
  ...
  fprintf(output, "  sdRxAdaptDone = %d\n", value->sdRxAdaptDone);
