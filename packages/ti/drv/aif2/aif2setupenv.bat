@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building AIF2
@REM ******************************************************************************
@REM * FILE NAME: pdksetupenv.bat
@REM *
@REM * DESCRIPTION: 
@REM *  Configures and sets up the Build Environment for AIF2. 
...
set XDCPATH=%XDC_INSTALL_PATH%/packages;%PDK_INSTALL_PATH%/.;%PDK_INSTALL_PATH%/../..;%C6X_GEN_INSTALL_PATH%/include;%EDMA3_LLD_INSTALL_PATH%/packages;
...
Title AIF2 LLD Build Environment
